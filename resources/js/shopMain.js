// (function ($) {
    ...
    */
    const quickview = {
        ...
        clickHandler: function(arg, arg2, arg3)
		{
            ...
            button.addClass('product-card__action--loading');
				...
				let route = '/catalog/quickview';
				
                $.ajax({
                    url: route,
					data: {brand:arg,article:arg2,uaid:arg3},
					type: 'POST',
    ...
    $(function () {
        ...
        $('.product-card__action--quickview').on('click', function()
		{
			...
			let args = $(this).find('input').val().split(',')
            quickview.clickHandler.apply(this, args);
        });
    });
