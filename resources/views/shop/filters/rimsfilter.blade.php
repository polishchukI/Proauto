...
<form method="POST" action="{{ route('special.rims') }}" style="width:100%;">
@csrf
	...
	<div class="widget-filters__list">
			...
			<div class="filter filter--opened" data-collapse-item="">
				...
				<div class="filter__body" data-collapse-content="">
					<div class="filter__container">
						<div class="filter-list">
							<div class="filter-list__list">
								@foreach ($ResultArray["rim_hole_number"] as $bkey=>$rim_hole_number)
									<label class="filter-list__item">
										<span class="input-check filter-list__input">
											<span class="input-check__body">
												<input class="input-check__input" onchange="javascript:this.form.submit();" name="rim_hole_number[]" value="{{$rim_hole_number}}" id="{{$rim_hole_number}}" type="checkbox" @if(request('rim_hole_number')) checked @endif>
												<span class="input-check__box"></span>
												<span class="input-check__icon">
													<svg xmlns="http://www.w3.org/2000/svg" width="9px" height="7px">
														<path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"></path>
										...
										<span class="filter-list__title">{{$rim_hole_number}}</span>
										@if(isset($ResultArray["ab_min_price_f"][$bkey]) && $ResultArray["ab_min_price_f"][$bkey]>0)
										<span class="filter-list__counter">{{Session::get('currency_symbol')}} {{$ResultArray["ab_min_price_f"][$bkey]}}</span>
										@endif
									</label>
		...
		<!--bolt_hole_circle testing-->
		<div class="widget-filters__item">
			<div class="filter filter--opened" data-collapse-item="">
				<button type="button" class="filter__title" data-collapse-trigger="">{{ __('catalog.bolt_hole_circle') }}
					<span class="filter__arrow"><svg xmlns="http://www.w3.org/2000/svg" width="12px" height="7px">
						<path d="M0.286,0.273 L0.286,0.273 C-0.070,0.629 -0.075,1.204 0.276,1.565 L5.516,6.993 L10.757,1.565 C11.108,1.204 11.103,0.629 10.747,0.273 L10.747,0.273 C10.385,-0.089 9.796,-0.086 9.437,0.279 L5.516,4.296 L1.596,0.279 C1.237,-0.086 0.648,-0.089 0.286,0.273 Z"></path></svg></span>
				</button>
				<div class="filter__body" data-collapse-content="">
					<div class="filter__container">
						<div class="filter-list">
							<div class="filter-list__list">
								@foreach ($ResultArray["bolt_hole_circle"] as $bkey=>$bolt_hole_circle)
									<label class="filter-list__item">
										<span class="input-check filter-list__input">
											<span class="input-check__body">
												<input class="input-check__input" onchange="javascript:this.form.submit();" name="bolt_hole_circle[]" value="{{$bolt_hole_circle}}" id="{{$bolt_hole_circle}}" type="checkbox" @if(request('bolt_hole_circle')) checked @endif>
												<span class="input-check__box"></span>
												<span class="input-check__icon">
													<svg xmlns="http://www.w3.org/2000/svg" width="9px" height="7px">
														<path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"></path>
										...
										<span class="filter-list__title">{{$bolt_hole_circle}}</span>
										@if(isset($ResultArray["ab_min_price_f"][$bkey]) && $ResultArray["ab_min_price_f"][$bkey]>0)
										<span class="filter-list__counter">{{Session::get('currency_symbol')}} {{$ResultArray["ab_min_price_f"][$bkey]}}</span>
										@endif
									</label>
