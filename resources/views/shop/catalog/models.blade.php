	...
	<div class="block-header block-header--has-breadcrumb block-header--has-title">
		<div class="container">
			<div class="block-header__body">
				...
				<!--div class="autopic" title="{{$ResultArray["ubrand"]}}" style="background:url({{$ResultArray["brand_logo_src"]}})"></div-->
				<div class="autopic">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														@foreach($arModels as $arModel)
															<div class="row">
																<a href="{{$arModel["model_url"]}}">{{$arModel["model_name"]}} ( {{$arModel["constructioninterval"]}} )</a>
															</div>
															@endforeach
														</div>
													</div>
