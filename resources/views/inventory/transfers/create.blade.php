@extends('inventory.layouts.app', ['page' => 'Register Transfer', 'pageSlug' => 'transfers', 'section' => 'transactions', 'search' => 'transfers'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transfer.index') }}" class="btn btn-sm btn-simple">
                                Back to List
                            </a>
                        </div>
                    </div>
