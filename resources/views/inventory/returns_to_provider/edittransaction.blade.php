@extends('inventory.layouts.app', ['page' => 'Edit Income', 'pageSlug' => 'sales', 'section' => 'inventory', 'search' => 'sales'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.show', $sale) }}" class="btn btn-sm btn-simple">Volver a la venta</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('sales.transaction.update', ['sale' => $sale, 'transaction' => $transaction]) }}" autocomplete="off">
                            ...
                            <input type="hidden" name="provider_id" value="{{ $sale->provider_id }}">
