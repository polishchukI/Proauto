@extends('inventory.layouts.app', ['page' => 'Expenses', 'pageSlug' => 'expenses', 'section' => 'transactions', 'search' => 'expenses'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.create', ['type' => 'expense']) }}" class="btn btn-sm btn-simple">Register Expense</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
