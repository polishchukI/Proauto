@extends('inventory.layouts.app', ['page' => 'Edit Income', 'pageSlug' => 'client_orders', 'section' => 'documents', 'search' => 'client_orders'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('client_orders.show', $client_order) }}" class="btn btn-sm btn-simple">Volver a la venta</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('client_orders.transaction.update', ['client_order' => $client_order, 'transaction' => $transaction]) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <input type="hidden" name="user_id" value="{{ $client_order->user_id }}">
