@extends('inventory.layouts.app', ['page' => __('inventory.new_repair_order'), 'pageSlug' => 'repair_orders', 'section' => 'documents', 'search' => 'repair_orders'])
		...
		<div class="card">
			<div class="card-header">
				<div class="row align-items-center">
					<div class="col-8">
						<h3 class="mb-0">{{ __('inventory.new_repair_order') }}</h3>
					</div>
					<div class="col-4 text-right">
						<a href="{{ route('repair_orders.index') }}" class="btn btn-sm btn-simple btn-back"><i class="fas fa-arrow-left"></i></a>
					</div>
				</div>
			</div>
			<div class="card-body">
			<form method="post" action="{{ route('repair_orders.store') }}" autocomplete="off">
