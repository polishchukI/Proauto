@extends('inventory.layouts.app', ['page' => 'Edit Category', 'pageSlug' => 'product_categories', 'section' => 'inventory', 'search' => 'product_categories'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('product_categories.index') }}" class="btn btn-sm btn-simple"><i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('product_categories.update', $category) }}" autocomplete="off">
                            @csrf
                            @method('put')
