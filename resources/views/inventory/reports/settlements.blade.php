            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
					<div class="row">
						...
						<div class="col-lg-3">
							<button type="button" class="btn btn-sm btn-primary" OnClick="client_settlements_show()">Report show</button>
						</div>
					</div>
                </div>
            </div>
