@extends('inventory.layouts.app', ['page' => __('inventory.new_product_price_group'), 'pageSlug' => 'product_price_groups', 'section' => 'inventory', 'search' => 'product_price_groups'])
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">{{__('inventory.new_product_price_group')}}</h3>
                    </div>
            ...
            <div class="card-body">
                <form method="post" action="{{ route('product_price_groups.store') }}" autocomplete="off">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{__('inventory.name')}}" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="col-2">
                                <div class="form-group{{ $errors->has('surcharge') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="surcharge" id="input-surcharge" class="form-control form-control-alternative{{ $errors->has('surcharge') ? ' is-invalid' : '' }}" default="0" placeholder="{{__('inventory.surcharge')}}">
                            ...
                            <div class="col-2">
                                <div class="form-group{{ $errors->has('surcharge_coefficient') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="surcharge_coefficient" id="input-surcharge_coefficient" class="form-control form-control-alternative{{ $errors->has('surcharge_coefficient') ? ' is-invalid' : '' }}" default="0" placeholder="{{__('inventory.surcharge_coefficient')}}">
