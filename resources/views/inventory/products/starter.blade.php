...
<div class="row">
	<div class="col-8">
		<h3 class="mb-0">{{ __('inventory.starter_parameters') }}</h3>
	</div>
</div>
<div class="row">
	<div class="col-3">
		<div><span class="option_capacity">01. Voltage</span></div>
		<select name="voltage" id="input-voltage" class="form-select form-control-alternative{{ $errors->has('voltage') ? ' is-invalid' : '' }}" required>
	...
	<div class="col-3">
		...
		<select name="polarity" id="input-polarity" class="form-select form-control-alternative{{ $errors->has('polarity') ? ' is-invalid' : '' }}" required>
...
<div class="row">
	<div class="col-3">
		...
		<select name="type" id="input-type" class="form-select form-control-alternative{{ $errors->has('type') ? ' is-invalid' : '' }}" required>
