@extends('inventory.layouts.app', ['page' => __('inventory.new_client_order_correction'), 'pageSlug' => 'client_order_corrections-create', 'section' => 'documents', 'search' => 'client_order_corrections'])
		...
		<div class="card">
			<div class="card-header">
				<div class="row align-items-center">
					<div class="col-8">
						<h3 class="mb-0">{{ __('inventory.new_client_order_correction') }}</h3>
					</div>
					<div class="col-4 text-right">
						<a href="{{ route('client_order_corrections.index') }}" class="btn btn-sm btn-simple btn-back"><i class="fas fa-arrow-left"></i></a>
					</div>
				</div>
			</div>
			<div class="card-body">
			<form method="post" action="{{ route('client_order_corrections.store') }}" autocomplete="off">
