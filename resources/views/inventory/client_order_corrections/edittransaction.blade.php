@extends('inventory.layouts.app', ['page' => 'Edit Income', 'pageSlug' => 'client_order_corrections', 'section' => 'inventory', 'search' => 'client_order_corrections'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('client_order_corrections.show', $client_order_correction) }}" class="btn btn-sm btn-simple">Volver a la venta</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('client_order_corrections.transaction.update', ['client_order_correction' => $client_order_correction, 'transaction' => $transaction]) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <input type="hidden" name="user_id" value="{{ $client_order_correction->user_id }}">
