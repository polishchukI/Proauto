@extends('inventory.layouts.app', ['page' => __('inventory.new_transaction'), 'pageSlug' => 'clients', 'section' => 'transactions', 'search' => 'clients'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('clients.show', $client) }}" class="btn btn-sm btn-simple"><i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
