		...
		<div class="card-header">
			<div class="row align-items-center">
				...
				<div class="col-4 text-right">
					<a href="{{ route('services_receipts.index') }}" class="btn btn-sm btn-simple"><i class="fas fa-arrow-left"></i></a>
				</div>
			</div>
		</div>
		<div class="card-body">
			<form method="post" action="{{ route('services_receipts.store') }}" autocomplete="off">
				...
				@if(isset($to_provider_order))
					<div class="row" hidden>
						<div class="col-4"></div>
						<div class="col-4"><input name="provider_id" value="{{ $to_provider_order->provider->id }}"></div>
						<div class="col-4"><input name="reference_type" value="to_provider_order"></div>
						<div class="col-4"><input name="reference_id" value="{{ $to_provider_order->id }}"></div>
					</div>
					@endif
					<div class="row">
						<div class="col-3">
