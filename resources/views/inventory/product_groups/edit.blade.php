@extends('inventory.layouts.app', ['page' => 'Edit Category', 'pageSlug' => 'categories', 'section' => 'inventory', 'search' => 'categories'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('categories.index') }}" class="btn btn-sm btn-simple"><i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
