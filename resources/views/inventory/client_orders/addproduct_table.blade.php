            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('client_orders.show', ['client_order' => $client_order]) }}" class="btn btn-simple btn-sm btn-back"><i class="fas fa-arrow-left"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body" style="max-height:100%;overflow:auto;">
                ...
                response.forEach(item => {
                    tbody +=
                        `<tr><td style="width: 15%;">${item.article}</a></td>
                            ...
                            <td><button type="button" class="btn btn-simple btn-sm btn-selector" id="${item.id}" OnClick="client_order_add_product('`+{{$client_order->id}}+`','${item.id}')"><i class="fas fa-check-double"></i></button></td>
                            </tr>`;
                })
