...
if(extension_loaded('curl')){
	...
	$URL = "https://tehnomir.com.ua/ws/xml.php?act=GetPriceWithCrosses&usr_login=".$aWs['login']."&usr_passwd=".$aWs['password']."&PartNumber=".$ArtNum."&currency=".$aWs['currency'];
	if($BrandID>0){$URL.="&BrandId=".$BrandID;}
	$URL = str_replace(' ','%20',$URL);
	//$URL = "https://tehnomir.com.ua/ws/xml.php?act=GetProducers&usr_login=".$Login."&usr_passwd=".$password."";
	$ch = curl_init($URL);
