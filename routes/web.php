...
Route::domain($admin_domain)->group(function ()
{
	...
	Route::group(['middleware' => 'auth'], function ()
	{
		...
		Route::post('/products/get_product_info',																						['as' => 'products.get_product_info', 'uses' => 'Inventory\ProductController@get_product_info']);
		...
		Route::post('/products_filter_by_search_with_crosses',																			['as' => 'products.filter.by.search.with.crosses', 'uses' => 'Inventory\ProductController@products_filter_by_search_with_crosses']);
		...
		Route::get('/transfers/{transfer}/print',																						['as' => 'transactions.print', 'uses' => 'Inventory\TransferController@print_transfer']);//+
		...
		//comment
		Route::post('/receipt_comment',																									['as' => 'receipts.comment', 'uses' => 'Inventory\ReceiptController@receipt_comment']);//+
		Route::post('/receipt_comment_update',																							['as' => 'receipts.comment.update', 'uses' => 'Inventory\ReceiptController@receipt_comment_update']);//+
		Route::delete('/receipt_comment_delete',																						['as' => 'receipts.comment.delete', 'uses' => 'Inventory\ReceiptController@receipt_comment_delete']);//+
		...
		Route::resource('warehouse_write_offs',																							'Inventory\WarehouseWriteOffController')->except(['edit','update']);
		Route::get('/warehouse_write_offs/{warehouse_write_off}/finalize',																['as' => 'warehouse_write_offs.finalize', 'uses' => 'Inventory\WarehouseWriteOffController@finalize']);
		Route::get('/warehouse_write_offs/{warehouse_write_off}/print',																	['as' => 'warehouse_write_offs.print', 'uses' => 'Inventory\WarehouseWriteOffController@print_warehouse_write_off']);//+
		Route::get('/warehouse_write_offs/{warehouse_write_off}/clear_products_table',													['as' => 'warehouse_write_offs.product.clear', 'uses' => 'Inventory\WarehouseWriteOffController@clear_products_table']);//+
		Route::get('/warehouse_write_offs/{warehouse_write_off}/product_selector',														['as' => 'warehouse_write_offs.product.selector', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_product_selector']);//+
		//warehouse_write_off_work_with_product_table
		Route::post('/warehouse_write_off_products_filter_by_group',																	['as' => 'warehouse_write_offs.products.filter.by.group', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_products_filter_by_group']);
		Route::put('warehouse_write_off_add_single_product_store',																		['as' => 'warehouse_write_offs.add.single.product.store', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_add_single_product_store']);//+
		Route::post('/warehouse_write_off_add_product',																					['as' => 'warehouse_write_offs.add.product', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_add_product']);//+
		Route::put('/warehouse_write_off_add_product_store',																			['as' => 'warehouse_write_offs.add.product.store', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_add_product_store']);//+
		Route::post('/warehouse_write_off_edit_product',																				['as' => 'warehouse_write_offs.product.edit', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_edit_product']);//+
		Route::post('/warehouse_write_off_update_product_store',																		['as' => 'warehouse_write_offs.product.update', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_update_product_store']);//+
		Route::delete('/warehouse_write_off_delete_product',																			['as' => 'warehouse_write_offs.product.delete', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_delete_product']);//+
		//comment
		Route::post('/warehouse_write_off_comment',																						['as' => 'warehouse_write_offs.comment', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_comment']);//+
		Route::post('/warehouse_write_off_comment_update',																				['as' => 'warehouse_write_offs.comment.update', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_comment_update']);//+
		Route::delete('/warehouse_write_off_comment_delete',																			['as' => 'warehouse_write_offs.comment.delete', 'uses' => 'Inventory\WarehouseWriteOffController@warehouse_write_off_comment_delete']);//+
		...
		//comment
		Route::post('/sale_comment',																									['as' => 'sales.comment', 'uses' => 'Inventory\SaleController@sale_comment']);//+
		Route::post('/sale_comment_update',																								['as' => 'sales.comment.update', 'uses' => 'Inventory\SaleController@sale_comment_update']);//+
		Route::delete('/sale_comment_delete',																							['as' => 'sales.comment.delete', 'uses' => 'Inventory\SaleController@sale_comment_delete']);//+
		...
		//correction		
		Route::resource('/client_order_corrections',																					'Inventory\ClientOrderCorrectionsController')->except(['edit', 'update']);
		Route::get('/client_order_corrections/{client_order_correction}/finalize',														['as' => 'client_order_corrections.finalize', 'uses' => 'Inventory\ClientOrderCorrectionsController@finalize']);
		Route::get('/client_order_corrections/{client_order_correction}/print',															['as' => 'client_order_corrections.print', 'uses' => 'Inventory\ClientOrderCorrectionsController@print']);
		Route::get('/client_order_corrections/{client_order_correction}/pay',															['as' => 'client_order_corrections.pay', 'uses' => 'Inventory\ClientOrderCorrectionsController@addtransaction']);
		Route::post('/client_order_corrections/{client_order_correction}/transaction_store',											['as' => 'client_order_corrections.transaction.store', 'uses' => 'Inventory\ClientOrderCorrectionsController@storetransaction']);
		Route::get('/client_order_corrections/{client_order_correction}/clear_products_table',											['as' => 'client_order_corrections.product.clear', 'uses' => 'Inventory\ClientOrderCorrectionsController@clear_products_table']);//+
		Route::get('/client_order_corrections/{client_order_correction}/product_selector',												['as' => 'client_order_corrections.product.selector', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_product_selector']);//+
		Route::get('/client_order_corrections/{client_order_correction}/add_client_ordered_product_table',								['as' => 'client_order_corrections.client.ordered.product.selector', 'uses' => 'Inventory\ClientOrderCorrectionsController@add_client_ordered_product_table']);//+
		Route::put('/client_order_correction_add_client_ordered_product',																['as' => 'client_order_corrections.add.client.ordered.product', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_add_client_ordered_product']);//+
		Route::post('/client_order_correction_products_filter_by_group',																['as' => 'client_order_corrections.products.filter.by.group', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_products_filter_by_group']);
		Route::put('client_order_correction_add_single_product_store',																	['as' => 'client_order_corrections.add.single.product.store', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_add_single_product_store']);//+
		Route::post('/client_order_correction_add_product',																				['as' => 'client_order_corrections.add.product', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_add_product']);//+
		Route::put('/client_order_correction_add_product_store',																		['as' => 'client_order_corrections.add.product.store', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_add_product_store']);//+
		Route::post('/client_order_correction_edit_product',																			['as' => 'client_order_corrections.product.edit', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_edit_product']);//+
		Route::post('/client_order_correction_update_product_store',																	['as' => 'client_order_corrections.product.update', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_update_product_store']);//+
		Route::delete('/client_order_correction_delete_product',																		['as' => 'client_order_corrections.product.delete', 'uses' => 'Inventory\ClientOrderCorrectionsController@client_order_correction_delete_product']);//+
		//////////////////////////////////////////////////		
		...
		Route::group(['namespace' => 'Inventory'], function ()
		{
			...
			Route::get('/admincarts/{admincart}/client_print',																			['as' => 'admincarts.client_print', 'uses' => 'AdminCartController@admincart_client_print']);//+
	...
	Route::group(['middleware' => 'auth', 'prefix' => 'reports'], function ()
	{
		...
		Route::post('/sales_by_categories_show',																						['as' => 'sales.by.categories.show',						'uses' => 'Inventory\ReportsController@sales_by_categories_show']);
...
Route::domain($domain)->group(function ()
{
	Route::group(['namespace' => 'AuthClient', 'prefix' => 'account', 'as' => 'account.'], function ()
	{
		...
		Route::get('/sales/{sale_id}',																									['as' => 'sales',							'uses' => 'SalesController@showSale']);
